                ...
                <div className="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Coupon code</div>
                  <div className="p-4">
                    <div className="d-flex" style={{ flexDirection: "column" }}></div>
                      <h1 className="text-center"><span class="badge badge-pill badge-success">{value.appliedCouponCode}<span className="ml-4" onClick={() => value.removePromotionFromCart()} ><i class="fas fa-times"></i></span></span></h1>
                    </div>
                  </div>
              );
      } else {
